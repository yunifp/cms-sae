...
export default function NewServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Filter fitur yang kosong sebelum disimpan
  ...
  return (
    <div className="flex flex-col gap-8 font-sans pb-12">
      ...
      <div className="flex flex-col gap-4">
        ...
        <h1 className="text-3xl font-semibold text-white">Tambah Layanan Baru</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#181A1F] border border-white/5 p-8 rounded-sm flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea 
                ...
                placeholder="Jelaskan detail yang termasuk dalam layanan ini..."
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex gap-2 items-center">
                   ...
                   <input 
                      ...
                      placeholder={`Fitur atau keunggulan ${index + 1}`}
        ...
        <div className="flex flex-col gap-6">
            ...
            <label className="border-2 border-dashed border-white/10 rounded-sm p-4 flex flex-col items-center justify-center gap-3 hover:border-[#DDF247]/30 transition-colors cursor-pointer group relative overflow-hidden h-40">
              {imagePreview ? (
                ...
                <>
                  ...
                  <p className="text-xs text-gray-400 text-center uppercase tracking-widest">Klik untuk unggah gambar</p>
                </>
              )}
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              {isLoading ? "Menyimpan..." : <><Save className="w-5 h-5" /> Simpan Layanan</>}
            </Button>
            <Button 
              type="button"
              variant="outline"
