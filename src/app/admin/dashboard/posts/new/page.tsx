  ...
  return (
    <div className="flex flex-col gap-8 font-sans pb-12 w-full">
      ...
      <div className="flex flex-col gap-4">
        ...
        <h1 className="text-3xl font-semibold text-white">Tambah Artikel Baru</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
          ...
          <div className="bg-[#181A1F] border border-white/5 p-8 rounded-sm flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <textarea 
                ...
                onChange={handleChange}
                placeholder="Ringkasan singkat yang akan muncul di halaman daftar artikel..."
        ...
        <div className="flex flex-col gap-6 min-w-0">
          <div className="bg-[#181A1F] border border-white/5 p-8 rounded-sm flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-2 w-full">
              <label className="text-sm text-gray-400">URL Slug (Opsional)</label>
              <input 
                type="text" 
                name="slug"
                value={formData.slug}
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <input 
                ...
                onChange={handleChange}
                placeholder="Contoh: Tips Renovasi, Arsitektur"
                className="w-full bg-[#121418] border border-white/10 text-white px-4 py-3 focus:outline-none focus:border-[#DDF247]/50 rounded-sm text-sm"
              />
            </div>
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            >
              <Save className="w-5 h-5" /> {isLoading ? "Menyimpan..." : "Simpan Artikel"}
            </Button>
            <Button 
              type="button"
              variant="outline"
